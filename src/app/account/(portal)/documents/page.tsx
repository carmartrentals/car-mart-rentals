        ...
        {customer?.documents_verified ? (
          <Alert tone="success">
            <span className="flex items-center gap-2">
              <ShieldCheck className="h-4 w-4" /> Your documents have been
          ...
          <Alert tone="info">
            <span className="flex items-center gap-2">
              <Clock className="h-4 w-4" /> Upload your documents below. Our team
              reviews them within one business day.
            </span>
          </Alert>
        )}
      </div>
